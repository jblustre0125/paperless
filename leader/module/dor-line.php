...
<body>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="../../leader/module/dor-line.php">
    ...
    <div class="container mt-5">
        <h4><i class="bi bi-tablet"></i> Line Management</h4>
        <p>Line management functionality will be implemented here.</p>
    </div>
