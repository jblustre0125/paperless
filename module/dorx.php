...
<form id="myForm" class="p-1 row" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
    <div class="container-fluid">
        <h3 class="text-center">Daily Operation Report (DOR)</h3>
        <div class="row">
        ...
        <div class="row p-1">
            <button type="submit" class="btn btn-primary form-control btn-lg" name="btnCreateDor" value="btnCreateDor">Generate Report</button>
        </div>
